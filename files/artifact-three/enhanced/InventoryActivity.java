...
public class InventoryActivity extends AppCompatActivity implements InventoryAdapter.OnItemActionListener {
    ...
    /**
     * Initializes the database helper instance and retrieves
    ...
    private void initializeDatabase() {
        ...
        if (currentUserId == -1) {
            Toast.makeText(this, "User account could not be loaded", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    ...
    private void setupRecyclerView() {
        ...
        itemList = databaseHelper.getAllItems(currentUserId);
    ...
    private void showAddItemDialog() {
        ...
        builder.setPositiveButton("Add", (dialog, which) -> {
            ...
            boolean inserted = databaseHelper.insertItem(currentUserId, itemName, quantity);
